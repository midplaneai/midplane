...
const INSERT_SQL = `
  INSERT INTO audit_events_index
    (id, customer_id, tenant_id, query_id, agent_identity, ts, event_type, payload, schema_version)
  VALUES ($1, $2, $3, $4, $5, to_timestamp($6::double precision / 1000), $7, $8::jsonb, $9)
`;
