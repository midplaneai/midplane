...
// Exported for the gateway heartbeat, which reports it as `policy_features` so
// the control plane can warn before publishing a bundle a gateway can't enforce.
