...
// DeleteProjectButton, minus the irreversibility). The pause itself is a
// Server Action passed in from the project workspace.
//
// Resume needs no dialog (it only restores service) — the workspace renders
// it as a bare form, so there's no matching ResumeProjectButton here.

export function PauseProjectButton({
  id,
  action,
}: {
  id: string;
