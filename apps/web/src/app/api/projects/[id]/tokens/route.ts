// GET  /api/projects/:id/tokens          — list this project's tokens
// POST /api/projects/:id/tokens          — mint a new token
//
// Security posture (matches /api/projects/[id]/route.ts):
//   - The session is the ONLY authentication path. No service-token
//     shortcut.
//   - 404 — not 401/403 — when the project is unknown OR belongs to a
...
export async function GET(
  ...
  if (rows === null) {
    // Unknown project OR owned by a different customer — same shape
