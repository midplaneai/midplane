// DELETE /api/projects/:id/tokens/:tokenId — revoke a token.
//
...
//
// 404 — not 401/403 — when the project OR the token is unknown OR
// owned by a different customer (same leakage-avoidance shape as the
// list/create route and the parent /api/projects/[id]).
