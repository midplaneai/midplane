// Auto-derived from the TermsFeed-generated Privacy Policy (source HTML
// kept verbatim). Rendered as trusted static markup on the matching
// /legal route. To revise the copy, edit it here — it is our own text.

export const PRIVACY_HTML = `<h1>Privacy Policy</h1>
<p>Last updated: June 04, 2026</p>
...
<li>
<p><strong>Application</strong> refers to Midplane, the software program provided by the Company.</p>
</li>
<li>
...
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Privacy Policy) refers to Deekard GmbH, Ella-Barowsky-Str. 17, 10829 Berlin, Germany.</p>
<p>For the purposes of the GDPR, the Company is the Data Controller.</p>
</li>
<li>
...
For the purposes of the GDPR, Service Providers are considered Data Processors.</p>
</li>
<li>
<p><strong>Usage Data</strong> refers to data collected automatically, either generated by the use of the Service or from the Service infrastructure itself (for example, the duration of a page visit).</p>
</li>
<li>
<p><strong>Website</strong> refers to Midplane, accessible from <a href="https://midplane.ai" rel="external nofollow noopener" target="_blank">https://midplane.ai</a>.</p>
</li>
<li>
...
<p>We use only strictly necessary Cookies to operate Our Service. These Cookies are set by Us, or by Our authentication provider on Our behalf, to keep You signed in, maintain Your session, and protect against fraudulent use of accounts. Without them, the services You have asked for cannot be provided.</p>
<p>A Cookie is a small file placed on Your Device. You can instruct Your browser to refuse Cookies or to indicate when a Cookie is being sent; however, if You do not accept Our strictly necessary Cookies, You may not be able to use parts of Our Service.</p>
<p>We do not use advertising, remarketing, or cross-context behavioral advertising Cookies, and We do not place third-party advertising trackers on the Service. Any product analytics We carry out are performed on Our own servers and do not rely on advertising identifiers.</p>
...
<li>
<p><strong>To contact You:</strong> To contact You by email regarding updates or informative communications related to the functionalities, products or contracted services, including security updates, when necessary or reasonable for their implementation.</p>
</li>
<li>
...
<ul>
<li>
<p>Website analytics data (IP addresses, device identifiers): up to 24 months from the date of collection, which allows us to analyze trends while respecting privacy principles.</p>
</li>
<li>
...
<p>Marketing Data</p>
<ul>
<li>Email Marketing: retained until you unsubscribe or up to 24 months from your last engagement (last email opened or clicked), whichever comes first.</li>
</ul>
</li>
<li>
<p>Financial and Transaction Data</p>
<ul>
<li>Payment information: credit/debit card details are not stored on Our servers; they are processed by our Payment Service Providers. We retain transaction records (invoice details, purchase history, amounts) for up to 10 years from the date of transaction to comply with tax laws and financial regulations.</li>
<li>Billing and invoice records: up to 10 years to meet accounting and tax compliance requirements.</li>
</ul>
</li>
</ul>
...
<p>Their Privacy Policy can be viewed at <a href="https://loops.so/privacy" rel="external nofollow noopener" target="_blank">https://loops.so/privacy</a></p>
</li>
</ul>
<h3>Payments</h3>
...
<p>We may transfer, store, and process Personal Data in countries other than the country in which You are located, including countries outside the European Economic Area (&quot;EEA&quot;) and the United Kingdom (&quot;UK&quot;), where data protection laws may differ.</p>
<p>Where we transfer Personal Data outside the EEA/UK to a country that has not been recognized as providing an adequate level of protection, We rely on appropriate safeguards, such as:</p>
<ul>
<li>The European Commission's Standard Contractual Clauses (&quot;SCCs&quot;) and/or the UK International Data Transfer Agreement (&quot;IDTA&quot;) or the UK Addendum to the SCCs (as applicable)</li>
<li>Supplementary measures where appropriate, such as encryption in transit and at rest, access controls, data minimisation, and vendor security reviews.</li>
</ul>
<p>We transfer Personal Data internationally only as needed to provide the Service and to work with our Service Providers (for example, hosting, analytics, email delivery). You may contact Us using the details in the &quot;Contact Us&quot; section of Our Privacy Policy to request further information about the safeguards We use for international transfers, including copies of relevant contractual protections (redacted where necessary).</p>
...
<li><strong>Request restriction of processing.</strong> You have the right to ask Us to restrict processing of Your Personal Data in certain circumstances (for example, while We verify accuracy or consider an objection).</li>
...
<p>Examples: A name, signature, physical characteristics or description, address, telephone number, passport number, driver's license or state identification card number, insurance policy number, education, employment, employment history, bank account number, credit card number, debit card number, or any other financial information, medical information, or health insurance information.</p>
...
<p>Examples: Approximate physical location, physical location or movements.</p>
<p>Collected: No.</p>
</li>
<li>
...
<p>Examples: Government-issued identifying numbers, financial account details, genetic data, precise geolocation, race or ethnicity, religious or philosophical beliefs, union membership, mail, email, text messages, biometric data, health data, and sexual orientation or sex life.</p>
<p>Collected: No.</p>
</li>
</ul>
...
<li><strong>Automatically from You</strong>. For example, through the strictly necessary cookies We set and through server-side logs as You navigate through our Service.</li>
...
<li>Other purposes consistent with the context in which the information was collected, or as otherwise disclosed to You at the time of collection.</li>
</ul>
<p>Please note that the examples provided above are illustrative and not intended to be exhaustive. For more details on how we use this information, please refer to the &quot;Use of Your Personal Information&quot; section.</p>
...
<p>We do not sell or share Your Personal Information, including for &quot;cross-context behavioral advertising&quot;, as those terms are defined under the CCPA/CPRA. We do not use advertising or remarketing partners, and We do not disclose Your Personal Information to third parties in exchange for money or other valuable consideration.</p>
<p>We share Personal Information with Our Service Providers (such as hosting, product analytics, email delivery, and payment processing) only for the business purposes described in this Privacy Policy, and under contracts that prohibit them from using it for their own purposes.</p>
<h3>Retention of Personal Information</h3>
<p>We retain California residents' Personal Information for as long as reasonably necessary to achieve the purposes described in this Privacy Policy (including the purposes disclosed in this CCPA/CPRA notice), taking into account: (i) how long we need the information to provide and maintain the Service and Your Account; (ii) whether You have requested deletion (subject to applicable exceptions); (iii) Our legal, tax, accounting, and regulatory obligations; (iv) security, fraud prevention, and abuse monitoring needs; and (v) the time periods needed to resolve disputes and enforce Our agreements.</p>
<p>Specific retention periods for major data categories are described in the &quot;Retention of Your Personal Information&quot; section of Our Privacy Policy, and We may retain certain information longer where required or permitted by law (for example, to comply with recordkeeping obligations or to establish, exercise, or defend legal claims).</p>
...
<p>We do not sell or share the Personal Information of any Consumer, including Consumers We know are under 16 years of age.</p>
<p>If You have reason to believe that a child under the age of 16 has provided Us with personal information, please contact Us with sufficient detail to enable Us to delete that information.</p>
...
<ul>
<li><strong>The right to notice.</strong> You have the right to be notified which categories of Personal Information are being collected and the purposes for which the Personal Information is being used.</li>
...
<li><strong>The right to say no to the sale or sharing of Personal Information (opt-out).</strong> You have the right to direct Us to not sell Your personal information. To submit an opt-out request, please see the &quot;Do Not Sell or Share My Personal Information&quot; section or contact Us.</li>
<li><strong>The right to correct Personal Information.</strong> You have the right to correct or rectify any inaccurate personal information about You that We collected. Once We receive and confirm Your request, We will use commercially reasonable efforts to correct (and direct our Service Providers to correct) Your personal information, unless an exception applies.</li>
<li><strong>The right to limit use and disclosure of sensitive Personal Information.</strong> You have the right to request to limit the use or disclosure of certain sensitive personal information We collected about You, unless an exception applies. To submit, please see the &quot;Limit the Use or Disclosure of My Sensitive Personal Information&quot; section or contact Us.</li>
<li><strong>The right to delete Personal Information.</strong> You have the right to request the deletion of Your Personal Information under certain circumstances, subject to certain exceptions. Once We receive and confirm Your request, We will delete (and direct Our Service Providers to delete) Your personal information from our records, unless an exception applies. We may deny Your deletion request if retaining the information is necessary for Us or Our Service Providers to:
<ul>
...
<p>Please see the &quot;Do Not Sell or Share My Personal Information&quot; section and &quot;Limit the Use or Disclosure of My Sensitive Personal Information&quot; section for more information on how to opt out and limit the use of sensitive information collected.</p>
...
<p>As defined in the CCPA/CPRA, &quot;sell&quot; and &quot;sale&quot; mean disclosing a Consumer's personal information to a third party for valuable consideration, and &quot;sharing&quot; means disclosing personal information for cross-context behavioral advertising.</p>
<p>We do not sell or share Your personal information, and We do not use it for cross-context behavioral advertising. Because We do not sell or share personal information, no opt-out is required to stop such activity. If You have questions or wish to confirm Your choices, You may contact Us at info@midplane.ai.</p>
...
<p>We do not collect or process sensitive personal information beyond what is strictly necessary to provide the Service, and We do not use or disclose it to infer characteristics about You. We do not sell or share sensitive personal information. For more information on how We use Your personal information, please see the &quot;Use of Your Personal Information&quot; section or contact us.</p>
<p>To submit a request to limit the use or disclosure of sensitive personal information, please contact Us using the methods listed in the &quot;Contact Us&quot; section of Our Privacy Policy.</p>
