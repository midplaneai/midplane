// Auto-derived from the TermsFeed-generated Terms and Conditions (source HTML
...
export const TERMS_HTML = `<h1>Terms and Conditions</h1>
...
<ul>
<li>
<p><strong>Application</strong> means the software program provided by the Company, named Midplane.</p>
</li>
<li>
...
<li>
<p><strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in these Terms and Conditions) refers to Deekard GmbH, Ella-Barowsky-Str. 17, 10829 Berlin, Germany.</p>
</li>
<li>
...
<li>
<p><strong>Free Tier</strong> refers to access to a limited set of the Service's features made available at no charge, without a paid Subscription.</p>
</li>
<li>
...
<h3>Billing</h3>
<p>You shall provide accurate and complete billing information, including a valid payment method and any billing details required by Our third-party payment processor.</p>
...
<h3>Free Tier</h3>
<p>The Company may make a Free Tier of the Service available at no charge. The Free Tier provides a limited set of features and is offered on an &quot;as is&quot; basis. You are not required to provide payment information to use the Free Tier.</p>
<p>At any time and without notice, the Company reserves the right to modify or discontinue the Free Tier, in whole or in part.</p>
<h2>User Accounts</h2>
...
<p>If the Service allows You to sign in, connect, or otherwise interact with a Third-Party Social Media Service, You authorize the Company to access and use information made available by that Third-Party Social Media Service in accordance with Our Privacy Policy and Your settings with that Third-Party Social Media Service.</p>
<p>The Company does not control and is not responsible for the availability, accuracy, or content of any Third-Party Social Media Service, and Your relationship with that Third-Party Social Media Service is governed by its own terms and policies.</p>
...
<p>Our trademarks and trade dress may not be used in project with any product or service without the prior written consent of the Company.</p>
...
<p>You acknowledge and agree that the Company shall not be responsible or liable, directly or indirectly, for any damage or loss caused or alleged to be caused by or in project with Your access to or use of any Third-Party Social Media Service, including any content, goods, or services made available through them. Your use of any Third-Party Social Media Service is governed by that Third-Party Social Media Service's terms and privacy policies.</p>
<h2>Termination</h2>
<p>We may terminate or suspend Your Account immediately, without prior notice or liability, for any reason whatsoever, including without limitation if You breach these Terms and Conditions.</p>
<p>Upon termination, Your right to use the Service will cease immediately. If You wish to terminate Your Account, You may simply discontinue using the Service.</p>
<p>If We terminate Your Subscription for convenience (and not due to Your breach), We will refund any prepaid fees covering the remainder of the term of the Subscription after the effective date of termination. In no event will any termination relieve You of the obligation to pay any fees payable to Us for the period prior to the effective date of termination.</p>
...
<p>To the maximum extent permitted by applicable law, in no event shall the Company or its suppliers be liable for any special, incidental, indirect, or consequential damages whatsoever (including, but not limited to, damages for loss of profits, loss of data or other information, for business interruption, for personal injury, loss of privacy arising out of or in any way related to the use of or inability to use the Service, third-party software and/or third-party hardware used with the Service, or otherwise in project with any provision of these Terms), even if the Company or any supplier has been advised of the possibility of such damages and even if the remedy fails of its essential purpose.</p>
