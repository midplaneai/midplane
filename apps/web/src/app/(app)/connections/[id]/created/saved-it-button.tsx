...
// only on click does it clear the cookie and head to the connection page,
// where the token list lives.
export function SavedItButton({ connectionHref }: { connectionHref: string }) {
