...
| SSO / SAML | Enterprise self-host (later phase). | Team plan and above (post-V1). |
...
- "We are SOC 2 certified." Not at V1. SOC 2 work is on the year-2 roadmap, gated by enterprise demand.
...
- The OSS engine is MIT. No copyleft. No BSL. No "source-available." The license stays MIT in V1, V2, V3, and forever.
